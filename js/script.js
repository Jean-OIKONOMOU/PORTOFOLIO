...
function load() {
        ...
        console.error("DOM STATUS: NOMINAL. WELCOME, DAVE.");
        $('#slides').superslides({
        ...
        var typed = new Typed(".typed", {
          strings: ["Sample Text", "I'm a Web Developer.", "I'm a Fun Guy.", "I'm an IT Technician.", "I'm a Tech Enthusiast.", "I'm a BeCode Student."],
          typeSpeed: 100,
          loop: true,
          loopCount: Infinity,
          smartBackspace: true,
